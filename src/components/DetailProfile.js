                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header title-modal center">
                                ...
                                <h4 className="modal-title" id="myModalLabel">Update Profile {lastName}</h4>
                            </div>
                            <form className="modal-body" onSubmit={this.updateProfile}>
                                <div className="form-group">
                                    <label htmlFor="firstName">First Name: </label>
                                    <input value={firstName} name="firstName" className="form-control" onChange={this.handleOnchangeFirstName} />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="lastName">Last Name: </label>
                                    <input value={lastName} name="lastName" className="form-control" onChange={this.handleOnchangeLastName} />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="email">Email address: </label>
                                    <input type="email" name="email" className="form-control" id="email" value={email} onChange={this.handleOnchangeEmail} />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="password">Password</label>
                                    <input type="password" name="password" className="form-control" id="password" value={password} onChange={this.handleOnchangePassword} />
                                </div>
